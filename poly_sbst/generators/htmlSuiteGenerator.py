...
import numpy as np
import random
from poly_sbst.generators.htmlGenerator import htmlGenerator
class HTMLTestSuiteGenerator(AbstractGenerator):
    """
    A class that generates test suites using a html generator.

    Attributes:
        _name (str): The name of the generator.
        test_gen (RandomGenerator): The html generator used to generate individual tests.
